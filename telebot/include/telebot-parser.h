...
/** Prase chat object */
telebot_error_e telebot_parser_get_chat_member(struct json_object *obj,
    telebot_chat_member_t *member);

/** Prase chat admins object */
telebot_error_e telebot_parser_get_chat_admins(struct json_object *obj,
    telebot_chat_member_t **admins, int *count);

/** Prase chat permissions object */
telebot_error_e telebot_parser_get_chat_permissions(struct json_object *obj,
...
telebot_error_e telebot_parser_get_animation(struct json_object *obj,
...
telebot_error_e telebot_parser_get_poll_option(struct json_object *obj,
    telebot_poll_option_t *option);

/** Prase poll answer object */
telebot_error_e telebot_parser_get_poll_answer(struct json_object *obj,
    telebot_poll_answer_t *answer);

/** Prase poll object */
telebot_error_e telebot_parser_get_poll(struct json_object *obj,
    telebot_poll_t *poll);

/** Prase dice object */
telebot_error_e telebot_parser_get_dice(struct json_object *obj,
    telebot_dice_t *dice);
...
/** Prase file object */
telebot_error_e telebot_parser_get_file(struct json_object *obj,
    telebot_file_t *file);
...
telebot_error_e telebot_parser_get_bot_command(struct json_object *obj,
    telebot_bot_command_t *command);

/** Prase array of bot command object */
telebot_error_e telebot_parser_get_array_bot_command(struct json_object *obj,
    telebot_bot_command_t **cmds, int *count);

/** Prase response paramters object */
telebot_error_e telebot_parser_get_response_parameters(struct json_object *obj,
